...
import { AppWindow, Bookmark, BookCheck, BrainCircuit, BookMarked, Users, Sparkles, Target, BookUser, ScrollText, Shield, SunMoon, BookLock, AudioLines, Telescope, Library, Calendar, BookOpen as SeerahIcon } from 'lucide-react';
...
export function MorePage() {
  ...
  const moreLinks = [
    ...
    { to: '/islamic-calendar', title: t('islamic_calendar_title'), subtitle: t('islamic_calendar_subtitle'), icon: Calendar, color: 'bg-fuchsia-500' },
    ...
    { to: '/adhkar', title: t('adhkar_title'), subtitle: t('adhkar_subtitle'), icon: SunMoon, color: 'bg-orange-500' },
    ...
    { to: '/nawawi-hadith', title: t('nawawi_hadith_title'), subtitle: t('nawawi_hadith_subtitle'), icon: ScrollText, color: 'bg-amber-500' },
    ...
    { to: '/sajda-verses', title: t('sajda_verses_title'), subtitle: t('sajda_verses_subtitle'), icon: BookMarked, color: 'bg-blue-500' },
    ...
    { to: '/reciters', title: t('reciters'), subtitle: t('reciters_page_subtitle'), icon: Users, color: 'bg-indigo-500' },
  ];
